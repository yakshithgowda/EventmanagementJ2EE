                ...
                <tbody id="table" class="table table-info">
                    ...
                    <% if (session.getAttribute("cid") != null && session.getAttribute("cid").equals(501)) {
                        	AdminDAO ad = new AdminDAO(session);
                                ArrayList<BookEventList> mydata = ad.getBookEventList();
                        ...
                        <tr>
							...
							<td>
                                ...
                                <%}else{%>
                                	<%= d.getStatus() %><br>
                                	<%-- <% Feedback f=ad.ifPresent( d.getBid() ); %> --%>
                                	<%if( ad.ifPresent( d.getBid() ) ){ %>
                                		<a href="ViewOneFeedback.jsp?bid=<%= d.getBid()%>" >view Feedback</a>                                 		
                                	<%} %>
                                <%} %>
