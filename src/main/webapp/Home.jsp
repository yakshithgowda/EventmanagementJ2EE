      ...
      <div class="row">
        ...
        <div class="col-md-4 p-3">
          <div class="card h-100" style="width: 18rem;">
            <img src="image/<%= e.getImg() %>" style="height:180px" class="card-img-top event-img" alt="Event Image">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="team-member text-center">
            <img src="https://w7.pngwing.com/pngs/973/860/png-transparent-anonym-avatar-default-head-person-unknown-user-user-pictures-icon-thumbnail.png" class="img-fluid rounded-circle" alt="Team Member 1">
            <h5>Akshay</h5>
        ...
        <div class="col-md-3">
          <div class="team-member text-center">
            <img src="https://w7.pngwing.com/pngs/973/860/png-transparent-anonym-avatar-default-head-person-unknown-user-user-pictures-icon-thumbnail.png" class="img-fluid rounded-circle" alt="Team Member 2">
            <h5>Shashank </h5>
        ...
        <div class="col-md-3">
            <div class="team-member text-center">
              <img src="https://w7.pngwing.com/pngs/973/860/png-transparent-anonym-avatar-default-head-person-unknown-user-user-pictures-icon-thumbnail.png" class="img-fluid rounded-circle" alt="Team Member 4">
              <h5>Vivek</h5>
              <p>Event Coordinator</p>
            </div>
          </div>
          <div class="col-md-3">
            <div class="team-member text-center">
              <img src="https://w7.pngwing.com/pngs/973/860/png-transparent-anonym-avatar-default-head-person-unknown-user-user-pictures-icon-thumbnail.png" class="img-fluid rounded-circle" alt="Team Member 5">
              <h5>Kashif</h5>
          ...
          <section class="">
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p>
                  At Event Management, we specialize in creating unforgettable events that leave lasting impressions. With a dedicated team of professionals and years of experience, we handle everything from intimate gatherings to grand celebrations.
                </p>
              </div>
              <!-- Grid column -->
